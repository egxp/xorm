...
func TestFormatColumnTime(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "format time (set length:3)",
			dialect:  nil,
			location: date.Location(),
			column:   &schemas.Column{SQLType: schemas.SQLType{Name: schemas.Time}, Length: 3},
			time:     date,
			wantRes:  date.Format("15:04:05.000"),
			wantErr:  nil,
		},
		{
			name:     "format time (set length:6)",
			dialect:  nil,
			location: date.Location(),
			column:   &schemas.Column{SQLType: schemas.SQLType{Name: schemas.Time}, Length: 6},
			time:     date,
			wantRes:  date.Format("15:04:05.000000"),
			wantErr:  nil,
		},
		{
			name:     "format time (set length:9)",
			dialect:  nil,
			location: date.Location(),
			column:   &schemas.Column{SQLType: schemas.SQLType{Name: schemas.Time}, Length: 9},
			time:     date,
			wantRes:  date.Format("15:04:05.000000000"),
			wantErr:  nil,
		},
		{
			name:     "format time (set length:64)",
			dialect:  nil,
			location: date.Location(),
		...
		{
			name:     "format datetime (set length:3)",
			dialect:  dialect{},
			location: date.Location(),
			column:   &schemas.Column{SQLType: schemas.SQLType{Name: schemas.DateTime}, Length: 3},
			time:     date,
			wantRes:  date.Format("2006-01-02 15:04:05.000"),
			wantErr:  nil,
		},
		{
			name:     "format datetime (set length:6)",
			dialect:  dialect{},
			location: date.Location(),
			column:   &schemas.Column{SQLType: schemas.SQLType{Name: schemas.DateTime}, Length: 6},
			time:     date,
			wantRes:  date.Format("2006-01-02 15:04:05.000000"),
			wantErr:  nil,
		},
		{
			name:     "format datetime (set length:9)",
			dialect:  dialect{},
			location: date.Location(),
			column:   &schemas.Column{SQLType: schemas.SQLType{Name: schemas.DateTime}, Length: 9},
			time:     date,
			wantRes:  date.Format("2006-01-02 15:04:05.000000000"),
			wantErr:  nil,
		},
		{
			name:     "format datetime (set length:64)",
			dialect:  dialect{},
			location: date.Location(),
		...
		{
			name:     "format timestamp (set length:3)",
			dialect:  dialect{},
			location: date.Location(),
			column:   &schemas.Column{SQLType: schemas.SQLType{Name: schemas.TimeStamp}, Length: 3},
			time:     date,
			wantRes:  date.Format("2006-01-02 15:04:05.000"),
			wantErr:  nil,
		},
		{
			name:     "format timestamp (set length:6)",
			dialect:  dialect{},
			location: date.Location(),
			column:   &schemas.Column{SQLType: schemas.SQLType{Name: schemas.TimeStamp}, Length: 6},
			time:     date,
			wantRes:  date.Format("2006-01-02 15:04:05.000000"),
			wantErr:  nil,
		},
		{
			name:     "format timestamp (set length:9)",
			dialect:  dialect{},
			location: date.Location(),
			column:   &schemas.Column{SQLType: schemas.SQLType{Name: schemas.TimeStamp}, Length: 9},
			time:     date,
			wantRes:  date.Format("2006-01-02 15:04:05.000000000"),
			wantErr:  nil,
		},
		{
			name:     "format timestamp (set length:64)",
			dialect:  dialect{},
			location: date.Location(),
		...
		{
			name:     "format timestampz (postgres)",
			dialect:  dialect{dbType: schemas.POSTGRES},
			location: date.Location(),
			column:   &schemas.Column{SQLType: schemas.SQLType{Name: schemas.TimeStampz}},
			time:     date,
			wantRes:  date.Format("2006-01-02T15:04:05.999999Z07:00"),
			wantErr:  nil,
		},
		{
			name:     "format int",
